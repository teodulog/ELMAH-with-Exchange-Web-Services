...
namespace Elmah
{
    ...
    public class ErrorMailModule : HttpModuleBase, IExceptionFiltering
    {
        ...
        private string _exchangeServerVersion;
#endif
        ...
        protected override void OnInit(HttpApplication application)
        {
            ...
            string exchangeUserName = GetSetting(config, "exchangeUserName", string.Empty);
            string exchangePassword = GetSetting(config, "exchangePassword", string.Empty);
            string autoDiscoverUrl = GetSetting(config, "autoDiscoverUrl", string.Empty);
            bool useExchangeWebservices = Convert.ToBoolean(GetSetting(config, "useExchangeWebServices", bool.FalseString));
            string exchangeServerVersion = GetSetting(config, "exchangeVersion", string.Empty);
            ...
            _autoDiscoverUrl = autoDiscoverUrl;
            _useExchangeWebServices = useExchangeWebservices;
            _exchangeServerVersion = exchangeServerVersion;
        ...
        /// <summary>
        /// Gets the user name to use if the Exchange Web Service is used.
        /// </summary>

        protected string ExchangeUserName
        {
            get { return _exchangeUserName; }
        }

        /// <summary>
        /// Gets the password to use if the Exchange Web Service is used.
        /// </summary>

        protected string ExchangePassword
        {
            get { return _exchangePassword; }
        }

        /// <summary>
        /// The auto discover url for .
        /// </summary>
        ...
        protected bool UseExchangeWebServices
        {
            get { return _useExchangeWebServices; }
        }
        ...
        protected string ExchangeServerVersion
        {
            get { return _exchangeServerVersion; }
        }
        ...
        /// <summary>
        /// Sends the e-mail using the Exchange Web Service.
        /// </summary>

        protected virtual void SendExchangeMail(MailMessage mail)
        {
            if (mail == null)
                throw new ArgumentNullException("mail");

            string userName = ExchangeUserName ?? string.Empty;
            string password = ExchangePassword ?? string.Empty;
            string autoDiscoverUrl = AutoDiscoverUrl ?? string.Empty;

            EmailMessage emailMessage = new EmailMessage(GetCloudEmailService(userName, password, autoDiscoverUrl));
            ...
            if (copyRecipient != string.Empty)
            {
                emailMessage.CcRecipients.Add(copyRecipient);
            }
        ...
        private ExchangeService GetCloudEmailService(string userName, string password, string autoDiscoverUrl)
        {
            ServicePointManager.ServerCertificateValidationCallback = CertificateValidationCallBack;
            ExchangeService service = new ExchangeService(GetExchangeVersion(ExchangeServerVersion));
        ...
        private ExchangeVersion GetExchangeVersion(string ExchangeServerVersion)
        {
            //Couldn't use a switch stmt b/c Emum.ToString() is a dynamic value not constant :/
            if (String.IsNullOrEmpty(ExchangeServerVersion))
            {
                return ExchangeVersion.Exchange2010_SP2;
            }
            else if(ExchangeServerVersion == ExchangeVersion.Exchange2007_SP1.ToString())
            {
                return ExchangeVersion.Exchange2007_SP1;
            }
            else if (ExchangeServerVersion == ExchangeVersion.Exchange2010.ToString())
            {
                return ExchangeVersion.Exchange2010;
            }
            else if (ExchangeServerVersion == ExchangeVersion.Exchange2010_SP1.ToString())
            {
                return ExchangeVersion.Exchange2010_SP1;
            }
            else if (ExchangeServerVersion == ExchangeVersion.Exchange2010_SP2.ToString())
            {
                return ExchangeVersion.Exchange2010_SP2;
            }
            else if (ExchangeServerVersion == ExchangeVersion.Exchange2013.ToString())
            {
